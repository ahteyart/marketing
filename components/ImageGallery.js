...
export default function ImageGallery({ content, product, type }) {
  ...
  const buildPrompt = () => {
    ...
    const style =
      type === "carousel"
        ? "carousel slide with bold headline text"
        : "social media advertisement";
    return `Professional ${style} for ${product}. ${caption}. Clean modern design, vibrant brand colors, high quality commercial photography, no text overlay.`;
  };
    ...
    <div className="card">
      ...
      {images.length === 0 && !loading && (
        <p className="text-sm text-gray-400 text-center py-8">
          Click &quot;Generate Image&quot; to create an AI-generated visual for this post
        </p>
      )}
        ...
        {images.map((img, i) => {
          ...
          return (
            <div key={i} className="relative aspect-square rounded-xl overflow-hidden bg-gray-100 group">
              ...
              <a
                href={src}
                download={`contentai-${type}-${i + 1}.png`}
